...
var VictoryBrushLine = function (_React$Component) {
  ...
  _createClass(VictoryBrushLine, [{
    ...
    value: function renderHandles(props) {
      ...
      var style = _assign({ cursor: cursor }, handleStyle);
    ...
    value: function renderBrush(props) {
      ...
      var baseStyle = Helpers.evaluateStyle(brushStyle, datum, activeBrushes.brush);
      var style = _assign({ cursor: "move" }, baseStyle);
    ...
    value: function renderBrushArea(props) {
      ...
      var baseStyle = Helpers.evaluateStyle(brushAreaStyle, datum, activeBrushes.brushArea);
      var style = _assign({ cursor: "crosshair" }, baseStyle);
