...
var VictoryBrushLine = function (_React$Component) {
  ...
  _createClass(VictoryBrushLine, [{
    ...
    value: function renderHandles(props) {
      ...
      var cursor = dimension === "x" ? "ew-resize" : "ns-resize";
      var style = (0, _assign3.default)({ cursor: cursor }, handleStyle);
    ...
    value: function renderBrush(props) {
      ...
      var baseStyle = _victoryCore.Helpers.evaluateStyle(brushStyle, datum, activeBrushes.brush);
      var style = (0, _assign3.default)({ cursor: "move" }, baseStyle);
    ...
    value: function renderBrushArea(props) {
      var brushAreaComponent = props.brushAreaComponent,
          ...
          brushAreaWidth = props.brushAreaWidth,
      ...
      var baseStyle = _victoryCore.Helpers.evaluateStyle(brushAreaStyle, datum, activeBrushes.brushArea);
      var style = (0, _assign3.default)({ cursor: "crosshair" }, baseStyle);
